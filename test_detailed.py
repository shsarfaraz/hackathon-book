...
def test_detailed_rag_service():
    print("Testing RAG service detailed response directly...")

    # Create RAG service instance
    rag_service = RAGService(collection_name="rag_embedding")

    # Test generate_detailed_response method (same as used in API)
    result = rag_service.generate_detailed_response("Docusaurus", top_k=5, response_type="standard")

    print(f"RAG Service Detailed Result:")
