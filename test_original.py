...
def test_original_query():
    ...
    # Test with the original query from the user
    result = rag_service.generate_response("tell me about this book", top_k=5)

    print(f"RAG Service Result for 'tell me about this book':")
